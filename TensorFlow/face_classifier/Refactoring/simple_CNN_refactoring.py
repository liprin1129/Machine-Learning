...
<<<<<<< HEAD:TensorFlow/face_classifier/simple_CNN_refactoring.py~
...
>>>>>>> parent of 7fe4582... refactoring, splitting image into windows in progress:TensorFlow/face_classifier/Refactoring/simple_CNN_refactoring.py
plt.ion()
plt.close('all')
