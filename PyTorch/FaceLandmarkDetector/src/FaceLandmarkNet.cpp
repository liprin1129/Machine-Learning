...
// ************************ //
// * FaceLandmarNetTest class * //
// ************************ //

FaceLandmarkNetTestImpl::FaceLandmarkNetTestImpl(int inputChannel, bool verbose) {
    //std::cout << "Constructor" << std::endl;
...
torch::Tensor FaceLandmarkNetTestImpl::forward(torch::Tensor x) {
